...
# Capture video
cap = cv2.VideoCapture('/Users/zhengbaoqin/Desktop/shan/speed/V1.mp4')
...
# not sure it is accurate for all the cases
...
if time_of_first_appearance is not None:
    ...
    milliseconds = int((time_of_first_appearance % 1) * 1000)
